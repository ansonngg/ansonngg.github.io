...
<ULItem>
    Implemented various advanced techniques, including light rendering, skybox visualization, normal mapping, and object
    instancing, to enhance the visual quality and performance of the project
</ULItem>
<ULItem>
    Developed separate shader and .obj file readers to decouple the reading logic from the rendering process,
